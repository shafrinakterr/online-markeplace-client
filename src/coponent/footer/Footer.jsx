...
const Footer = () => {
    return (
        <footer className="footer border mt-20 bg-blue-200 border-primary-color text-primary-color footer-center p-10 rounded-xl ">
            <aside>
                <img className="w-20" src="https://i.ibb.co/vdKFLVf/logoooo.png" alt="" />
